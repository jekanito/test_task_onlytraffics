...
@section('title', 'Добавить новую анкету')

@section('h1', 'Добавить анкету')

@section('breadcrumbs')
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{ route('main') }}">Главная</a></li>
        <li class="breadcrumb-item"><a href="{{ route('questionnaires.index') }}">Анкеты</a></li>
        <li class="breadcrumb-item active">Добавить анкету</li>
    </ol>
@endsection
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Добавить новую анкету</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
